...
I used `summarise()` above to calculate the total number of songs in the "Rock" genre, but let's expand that code to also calculate 
...
Modify the code chunk below to compute three statistics:
